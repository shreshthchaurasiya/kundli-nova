-- Fix processed_at column reference in admin dashboard summary
-- The correct columns are paid_at, rejected_at, failed_at - not processed_at
...
BEGIN
    ...
    -- Add AI Subscriptions Revenue to Company Revenue
    ...
    -- Use paid_at instead of processed_at (correct column name)
